    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerText}>Manager Expenses Entry</Text>
            </View>
            ...
            <View style={styles.section2}>
                <View style={styles.boxContainer}>
                    <View>
                        <TouchableOpacity onPress={() => navigation.navigate('ManagerFoodType')}>
                    ...
                    <View>
                        <TouchableOpacity onPress={() => navigation.navigate('ManagerTransportationType')}>
                            <View style={styles.box}>
                    ...
                    <View>
                        <TouchableOpacity onPress={() => navigation.navigate('ManagerAccommodationType')}>
                            <View style={styles.box}>
...
export default ExpenseEntriesManager;
